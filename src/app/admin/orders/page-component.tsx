...
import { updateOrderStatus } from '@/src/app/actions/orders';
            ...
            <TableRow key={order.id}>
              ...
              <TableCell>
                ...
                >
                  ...
                  <SelectContent className='backdrop-blur-md bg-white/80 dark:bg-gray-900/80'>
              ...
              <TableCell>
                <Dialog>
                    ...
                    <Button
                      ...
                      onClick={openProductsModal(
                        orderedProducts.filter(
                          (item: { order_id: number }) => item.order_id === order.id
                        )
                      )}
                    >
                      View Products
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle className='flex flex-col text-2xl text-[#fb4570]'>Order Products</DialogTitle>
                    </DialogHeader>
                      ...
                      {selectedProducts.map(({ product }, index) => (
                        ...
                        >
                          ...
                          <div className='flex flex-col'>
                            <span className='font-semibold text-[#fb4570]'>
                              {product.title}
                            </span>
                            <span className='font-medium text-[#f9f5f8ff]'>
                              ${(Math.round(product.price) / 100).toFixed(2)}
                            </span>
                            <span className='text-sm text-[#f9f5f8ff]'>
