...
export default function Home() {
  ...
  return <div className='min-h-screen'>
      <header className='container mx-auto px-4 py-6 flex justify-between items-center'>
        <h1 className='text-2xl font-bold'>Muginifinity App</h1>
      </header>
          ...
          <Card className='bg-[#1BC464] text-white'>
            <CardContent className='p-8 text-center'>
              ...
              <div className='flex flex-wrap justify-center gap-4 md:gap-0 md:flex-nowrap md:space-x-4'>
                <Button size='lg' className='bg-white text-gray-900 hover:bg-indigo-100'>
                  <Image
                    src='/assets/apple.jpeg'
                    alt='App Store'
      ...
      <footer className='bg-[#1BC464] text-white py-6'>
        <div className='container mx-auto px-4 flex flex-col items-center gap-4'>
          <div className='flex items-center gap-6'>
            {/* <Link
              href='https://www.linkedin.com/in/rita-koon'
              target='_blank'
            ...
            <Link
              href='https://youtube.com/@ritakoon1775'
              target='_blank'
              className='flex items-center gap-2 hover:opacity-80 transition-opacity'
